...
<template>
  <aside class="w-64 bg-white border-r border-gray-200 flex-shrink-0 flex flex-col h-full p-4">
    ...
    <nav class="flex-1 space-y-1 overflow-y-auto">
      ...
      <router-link to="/dashboard/admin/softwares" active-class="bg-blue-50 text-primary-light" class="flex items-center gap-3 px-4 py-2 rounded-xl text-gray-600 hover:bg-gray-50 transition-colors">
        <i class="fas fa-cubes w-5 text-center"></i> Catalogue
      </router-link>
      <router-link to="/dashboard/admin/projects" active-class="bg-blue-50 text-primary-light" class="flex items-center gap-3 px-4 py-2 rounded-xl text-gray-600 hover:bg-gray-50 transition-colors">
        <i class="fas fa-code-branch w-5 text-center"></i> Projets
      </router-link>
      <router-link to="/dashboard/admin/reports" active-class="bg-blue-50 text-primary-light" class="flex items-center gap-3 px-4 py-2 rounded-xl text-gray-600 hover:bg-gray-50 transition-colors">
        <i class="fas fa-file-lines w-5 text-center"></i> Rapports
      </router-link>
      <router-link to="/dashboard/admin/payments" active-class="bg-blue-50 text-primary-light" class="flex items-center gap-3 px-4 py-2 rounded-xl text-gray-600 hover:bg-gray-50 transition-colors">
        <i class="fas fa-money-bill-wave w-5 text-center"></i> Paiements
      </router-link>
      <router-link to="/dashboard/admin/statistics" active-class="bg-blue-50 text-primary-light" class="flex items-center gap-3 px-4 py-2 rounded-xl text-gray-600 hover:bg-gray-50 transition-colors">
        <i class="fas fa-chart-pie w-5 text-center"></i> Statistiques
      </router-link>
