  ...
  <div>
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
      <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
        ...
        <p class="text-2xl font-bold text-gray-800">{{ stats.totalClients || 0 }}</p>
      </div>
      <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
        <p class="text-gray-500 text-sm">Total Devis</p>
      ...
      <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
        <p class="text-gray-500 text-sm">Total Rapports</p>
        <p class="text-2xl font-bold text-green-500">{{ stats.totalReports || 0 }}</p>
      </div>
      <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
        <p class="text-gray-500 text-sm">Notifications non lues</p>
